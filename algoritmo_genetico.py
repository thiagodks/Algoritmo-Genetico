...
populacao = Populacao(npop=100, nger=100, elitismo=True)
populacao.inicializa_indiv(taxa_mutacao=0.05, taxa_cruzamento=0.8, pv=0.9, nbits=6, ndim=10, xmax=3, xmin=-3)
